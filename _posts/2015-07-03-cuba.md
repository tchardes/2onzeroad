...
Pour cette fois, nous avons joué les petits bras. Ne parlant pas espagnol (on va s'y mettre !!!) et connaissant les difficultés de déplacement et d'accès à l'essentiel, nous avons décidé de nous tourner vers une agence pour partir en voyage organisé. Ne souhaitant pas passer par la case bronzette à Varadero, nous optons pour un circuit d'une semaine au nom évocateur de « tour mojito » au départ de Fort-de-France (Martinique). Notre parcours nous a conduit à <a href="{{site.baseurl}}{% post_url 2015-06-25-cuba-havane %}" style="width:100%">La Havane</a>, <a href="{{site.baseurl}}{% post_url 2015-06-27-cuba-vinales %}" style="width:100%">Viñales</a>, **la Baie des cochons**, <a href="{{site.baseurl}}{% post_url 2015-06-27-cuba-cienfuegos %}" style="width:100%">Cienfuegos</a>, <a href="{{site.baseurl}}{% post_url 2015-06-27-cuba-trinidad %}" style="width:100%">Trinidad</a> et <a href="{{site.baseurl}}{% post_url 2015-06-27-cuba-santa-clara %}" style="width:100%">Santa Clara</a>.   
