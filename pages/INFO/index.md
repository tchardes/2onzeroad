...
Finalement l'application smartphone de N26 à bien évoluée depuis notre départ et maintenant nous pouvons valider notre achat directement dans celle-ci, plus besoins de recevoir un code SMS ou mail pour l'authentification forte.

## Communication

### Téléphonie

Pour les premiers mois de notre voyage nous aurons uniquement notre SIM Free avec un abonnement à 19,99€ qui permet, depuis le 14 mars 2017, de téléphoner et d'envoyer SMS et MMS en illimités + 25Go de data par mois depuis certaines destinations, dont notamment les USA et le Canada. Dès que nous rentrerons en Amérique latine nous passerons notre abonnement Free à 2€ et prendrons une carte SIM chez un opérateur local.

#### Mexique

Dès notre entrée au Mexique nous avons ouvert une ligne chez l'opérateur Telcel avec un abonnement à 8,90 $/mois (200$/Mex, voix, SMS et réseaux sociaux illimités plus 1,5 Go pour internet). Nous avons gardé Free pour les 25 Go de datas et nous avons utilisé Telcel pour téléphoner en local et utiliser les réseau sociaux.
...
Quelles sont les motivations de ce choix ?, **qui reste personnel et adapté à notre vision des choses**. **_(Maj 2020)_**
...
- Il est de plus en plus difficile aux voyageurs équipés de leur CC immatriculé en Europe de trouver une assurance qui veuille bien les prendre en compte que cela soit aux USA ou au Canada, à un prix raisonnable. S'il y a bien un endroit où il ne faut pas plaisanter avec les assurances c'est bien dans ces deux pays.

- Au niveau motorisation, les RVs sont équipés le plus souvent de moteurs Ford V10 6.8l pour 310 Ch à Gazoline (essence) ou, de plus en plus, de moteurs Mercedes V6 3l pour 188 Ch, diesel sur châssis Sprinter. Les moteurs Ford sont très gourmands et devant l'augmentation du prix de l'or noir, ils équipent également leurs derniers modèles de Class B+ ou C d'un moteur turbo diesel de 6l pour 325 Ch. Ces motorisations ont l'avantage d'être moins pointues que les moteurs européens avec leurs normes Euro 5, Euro 6... et donc avec moins d'électronique embarquée et moins regardantes sur la qualité des carburants assez inégale, même entre les différents états des États-Unis.
...
- **iOverlander** - _Base de données des endroits pour des overlanders et des voyageurs. Il inclut camper, hôtels, restaurants, mécanique, l'eau, remplissage de propane et plein d'autres catégories_ ;
- **OsmAnd Maps** - _Application cartographique et de navigation avec accès aux données libres OpenStreetMap (OSM), à la couverture mondiale de haute qualité. Toutes les données cartographiques peuvent être stockées sur la carte mémoire de votre appareil pour une utilisation hors-ligne_ ;
- **Maps.Me** - _Application de cartographie permettant de télécharger localement les cartes du monde entier pour une consultation hors-ligne. Maps.me dispose d'un mode itinéraire utilisable partout dans le monde_ ;
- **Google Maps** - _On ne présente plus - On peut télécharger à l'avance des zones qui seront disponibles hors connexion_ ;
- **Conseils aux voyageurs** - _Site du MAE - Conseils par pays · Dernières minutes · Fiches Réflexes · Infos pratiques · Foire aux questions · Services aux citoyens · Préparer son voyage_ ;
- **Walmart Overnight Parking locator** - _Toutes les informations sur Walmart qui acceptent les RV la nuit. Aux USA et Canada_ ;
- **Dropbox** - _Héberge tous vos fichiers (documents, photos, vidéos, etc.). Les fichiers que vous stockez dans Dropbox sont conservés en lieu sûr et accessibles sur tous vos appareils. L'envoi de fichiers volumineux se fait en toute simplicité, même si le destinataire n'a pas de compte Dropbox_ ;
- **Skype** - _Pour communiquer avec les proches_ ;
- **GasBuddy** - _Uniquement sur le store Amérique du Nord - Vous indique le prix de l'essence le moins cher autour de vous. Aux USA et Canada_ ;
- **Allstays** - _Application participative qui liste tous les endroits utiles aux voyageurs, Campings, Walmarts, state parks, Propanes ... Aux USA et Canada)_ ;
- **Campendium** - _Application participative qui liste tous les bivouacs et dump station utiles aux voyageurs, Campings, Walmarts, state parks, Parkings... Aux USA et Canada)_ ;
- **AroundMe** - _Vous liste automatiquement les lieux qui peuvent être utiles autour de vous, Hôpitaux, Banques, Parkings…_ ;
...
- **Photo Transit** - _Outil de planification plan basé sur une carte pour les photographes de plein air qui utilisent des appareils photo à objectifs interchangeables (comme SLR s). Planifiez le meilleur appareil photo possible, des lentilles et des lieux de tournage pour votre voyage de photo ou de la cession en utilisant le complexe intégré dans le champ de vue simulateur_ ;
- **Gps4cam** - _Permet de géotaguer vos photos prises avec votre appareil photo préféré. Fini le temps où vous vous demandiez où vous aviez pris vos photos : gps4cam pro les localise toutes ! L’application fonctionne avec toutes les marques d’appareil photo et ne nécessite aucune synchronisation manuelle entre votre appareil photo et votre iPhone. De plus, gps4cam peut être utilisé sans connection au réseau, ce qui est idéal pour les voyages à l’étranger_ ;
- **NDExposure** - _Permet de calculer le temps d'exposition correcte lors de l'utilisation des filtres à densité neutre_ ;
- **Digital DoF** - _Permet de calculer l'hyperfocale_ ;
- **TL Calc** - _Une calculatrice time-lapse rapide et simple avec trois modes. Le mode par défaut vous permet de déterminer l'intervalle d'obturation (temps entre plans) qui est nécessaire pour atteindre une longueur de clip vidéo souhaitée pour une durée d'enregistrement donné_ ;
- **Capture** - _Logiciel GoPro_.
...
- [road trippin](http://www.road trippin.fr/) - Guide - Forum - Préparation voyage aux USA ;
...
- [Yann et Summer](https://www.facebook.com/ByZWay) : Yann et son chien summer rencontrés le 03 avril 2022 à Trujillo au Pérou au camping Ramada Campestre.
...
- Flavia, Maximilien et leurs trois enfants, famille argentine qui voyage à bord d'un CC mercedes, rencontrés au Refuge Lima à Cieneguilla, Pérou le 09 octobre 2023.
